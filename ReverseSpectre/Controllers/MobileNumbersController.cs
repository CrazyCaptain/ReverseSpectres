...
namespace ReverseSpectre.Controllers
{
    public class MobileNumbersController : Controller
    {
        ...
        {
            var mobileNumbers = db.MobileNumbers.Include(m => m.User);
        ...
        public ActionResult Create([Bind(Include = "MobileNumberId,MobileNo,Token,DateTimeCreated,IsDisabled,IsPrimary,UserId")] MobileNumber mobileNumber)
        {
            ...
            ViewBag.UserId = new SelectList(db.Users, "Id", "FirstName", mobileNumber.UserId);
            return View(mobileNumber);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MobileNumberId,MobileNo,Token,DateTimeCreated,IsDisabled,IsPrimary,UserId")] MobileNumber mobileNumber)
        {
            if (ModelState.IsValid)
            {
